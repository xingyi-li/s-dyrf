...
class Optim_Config:
    ...
    batch_size: int = 4096
    n_iters: int = 25000
    n_iters_style: int = 657000


@dataclass
class Style_Config:
    ref_data_dir: str = ""
    dataset_type: str = "neural3D_NDC"  # choose from "dnerf", "neural3D_NDC"
    scene_name: str = "coffee_martini"
    style_img: Optional[list] = None
    style_multiview: bool = False
    style_img_multiview: Optional[list] = None
    multiview_img_cam_idx: Optional[list] = None
    tmpl_idx_train: Optional[list] = None
    tmpl_idx_test: Optional[list] = None
    color_pre: bool = True
    style_name: str = ""
    out_dir: str = "./stylize/"

    vgg_blocks: Optional[list] = None
    exchange_tmp: bool = True
    fast: bool = False
    loss_names: Optional[list] = None
    content_weight: float = 0.005
    # content_weight: float = 0.0005
    tcm_weight: float = 1.
...
class Config:
    ...
    render_specific_pose: bool = False
    render_specific_time: bool = False
    ...
    style: Style_Config = Style_Config()
